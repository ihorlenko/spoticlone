...
- [x] **15.2** Перевірити роботу на iOS Simulator
- [x] **15.3** Перевірити роботу на macOS (Mac Catalyst)
- [x] **15.4** Перевірити що MiniPlayer відображається коректно на обох платформах
